...
const Color DEFAULT_COLOR = Color(254, 44, 44, 255);
const Color DARK_BLUE = Color(68, 61, 255, 255);

static int const SCREEN_WIDTH = 600;
static int const SCREEN_HEIGHT = 600;
static int const AMOUNT_OF_RECTANGLES = 9;

const unsigned SQUARE_WIDTH = 30;
const unsigned SQUARE_HEIGHT = 30;
